...
export const metadata: Metadata = {
  title: "Mentions légales | Ava Bien-Etre",
  description:
    "Mentions légales du site Ava Bien-Etre: éditeur, direction de publication et hébergeur.",
  keywords: [
    "mentions légales ava bien-etre",
    "éditeur site avabienetre.fr",
    "hébergeur OVH",
    "informations légales retraite bien-etre",
  ],
  alternates: {
      ...
      <div className="container mx-auto max-w-4xl space-y-8">
        <header className="space-y-3">
          ...
          <p className="text-muted-foreground">
            Ce site internet est édité par Ava Bien Etre, entrepreneur individuel sous le numéro SIREN 830502555 et
          ...
          <p className="text-muted-foreground">
            ...
            est hébergé par la société OVH, SAS au capital de 10 069 020 euros, RCS Lille Metropole 424 761 419
        ...
        <section className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Les contenus du site (textes, visuels, images, logo, structure) sont protèges par le droit de la Propriété
        ...
        <section className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Ava Bien Etre s&apos;efforce de fournir des informations exactes et à jour. Toutefois, des erreurs ou omissions
        ...
        <section className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Le traitement des données personnelles et l&apos;utilisation des cookies sont detailles dans la politique de
